...
var SparklinesReferenceLine = function (_React$Component) {
    ...
    _createClass(SparklinesReferenceLine, [{
        key: 'refValueToPoint',
        value: function refValueToPoint(data, height, margin, refValue) {
        ...
        value: function render() {
            ...
            var y = type === 'custom' ? this.refValueToPoint(data, height, margin, value) : dataProcessing[type](ypoints);
...
var _max2 = __webpack_require__(5);
...
var _max = __webpack_require__(5);
